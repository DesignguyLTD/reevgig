...
const ApplicantProfilePage = () => {
  ...
  <Seo
    title={
      "Applicant Profile | View Application Details, Proposal & Resume for Top Talent"
    }
    description={
      "Discover top talent by reviewing detailed applicant profiles, proposals, resumes, and completed projects. Assess skills, experience, and rates to make the best hiring decision."
    }
    og_title="Applicant Profile - View Application Details & Proposals"
    og_desc="Explore detailed applicant profiles, proposals, and resumes. Evaluate skills, experience, and completed projects to find the right candidate for your team."
    site_name={"Reevgig"}
    type="website"
  />;
  return (
          ...
          <div className={appstyle.ApplicantHeaderCnt}>
              ...
              <div className={appstyle.ApplicantHeaderUserCnt}>
                <div className={appstyle.ApplicantHeaderUserData}>
                  ...
                  <div className={appstyle.ApplicantHeaderUser}>
                    <div className={appstyle.ApplicantHeaderUserText1}>
                      Front End Developer
                    </div>
                    <div className={appstyle.ApplicantHeaderUserText2}>
                      Seyifunmi Odediran
                    </div>
                  </div>
                </div>
                <div className={appstyle.ApplicantHeaderBtnCtn}>
                  <button className={appstyle.ApplicantHeaderBtn1}>
                    Send Message
                  </button>
                  <img
                    className={appstyle.ApplicantHeaderBtn3}
                    src="https://res.cloudinary.com/do5wu6ikf/image/upload/v1728589724/Reev/10th%20oct/Button_m98tqy.svg"
                    alt="messageBtn"
                  />
                  <button className={appstyle.ApplicantHeaderBtn2}>
                    Place Order
                  </button>
                  <img
            ...
            <div className={appstyle.ApplicantMainBodyLowerCtn}>
              <div className={appstyle.ApplicantHeaderCtrl}>
                <div
                  className={appstyle.ApplicantHeaderCtrlText}
                  style={{
                    color: header === "Proposal" ? "black" : "",
                    borderBottom:
                      header === "Proposal" ? "solid 2px black" : "",
                  }}
                  onClick={() => handleHeader("Proposal")}>
                  Proposal
                </div>
                <div
                  className={appstyle.ApplicantHeaderCtrlText}
                  ...
                  {header === "Proposal" && (
                    <>
                      <div className={appstyle.ProposalCtn}>
                        <div className={appstyle.ProposalText1}>
                          About Seyi Odediran
                        </div>
                        <div className={appstyle.ProposalText2}>
                          Here at Velstar, we don't just make websites, we
                          ...
                          Interface Design, to Digital Marketing, we have a
                          proven track record in delivering outstanding
                ...
                <div className={appstyle.ApplicantMainBodyHeaderCtn2}>
                  <div className={appstyle.ApplicantMainBody2}>
                    <div className={appstyle.ApplicantMainBodyRate}>
                      <div className={appstyle.ApplicantMainBodyRateText1}>
                        Rate
                      </div>
                      <div className={appstyle.ApplicantMainBodyRateText2}>
                        $50,000 - $80,000
                      </div>
                      <div className={appstyle.ApplicantMainBodyRateText1}>
                        Monthly
                    ...
                    <div className={appstyle.ApplicantMainBodySkill}>
                      <div className={appstyle.ApplicantMainBodySkillTag2Ctn}>
                        <div className={appstyle.ApplicantMainBodySkillTag1}>
                          Skills
                        </div>
                      </div>
                      <div className={appstyle.ApplicantMainBodySkillTag2Ctn}>
                        <div className={appstyle.ApplicantMainBodySkillTag2}>
                          Hardware
                        </div>
                        <div className={appstyle.ApplicantMainBodySkillTag2}>
                          Javascript
                  ...
                  <div className={appstyle.ApplicantMainBody3}>
                    <div className={appstyle.ApplicantMainBody3Top}>
                      <div className={appstyle.ApplicantMainBody3TopText}>
                        Overview
                      </div>
                    </div>
                    <div className={appstyle.ApplicantMainBody3Middle}>
                      <div className={appstyle.ApplicantMainBody3MiddleComp}>
                        ...
                        <div className={appstyle.ApplicantMainBody3Middle2}>
                          Project Completed
                        </div>
                        <div className={appstyle.ApplicantMainBody3Middle3}>
                          55+
                        </div>
                      </div>
