...
const JobApplicationPage = () => {
  <Seo
    title={"Manage Job Applications | Track & Shortlist Candidates – Reevgig"}
    description={
      "Streamline your hiring process with Reevgig's job application dashboard. Track, shortlist, and manage applications efficiently."
    }
    site_name={"Reevgig"}
    og_title="Manage Job Applications | Reevgig"
    og_desc="Reevgig helps you track, sort, and shortlist job applications seamlessly. Simplify your recruitment process today."
  />;
  ...
  return (
    <div>
      <div>
        <div className={JAStyles.JobHeaderText}>Job Application</div>
            ...
            <div className={JAStyles.applicationsColumn}>
              <div className={JAStyles.overAllHeaderCtn}>
                <div className={JAStyles.overAllHeaderTextCtn}>
                  <div
                    className={JAStyles.overAllHeaderText}
                    style={{
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderBottom:
                        header === "shortlistedApps" ? "solid 2px black" : "",
                    }}
    ...
    <div className={JAStyles.jobCard}>
      ...
      <div className={JAStyles.jobCardUserStatusCtn}>
        <img
          ...
          alt="Clock"
        />
        <div className={JAStyles.jobCardUserStatusText}>{app.jobType}</div>
        ...
        <img
          ...
          alt="Currency"
        />
        <div className={JAStyles.jobCardUserStatusText}>{app.salary}</div>
        <div className={JAStyles.circle}></div>
        <img
          src="https://res.cloudinary.com/dvjx9x8l9/image/upload/v1726012509/CalendarBlank_zupxlc.svg"
          alt="Calendar"
        />
        <div className={JAStyles.jobCardUserStatusText}>{app.timeAgo}</div>
      </div>
      ...
      <div className={JAStyles.BtnCtn}>
        ...
        <button
          ...
          onClick={
            app.shortlisted ? handleNav : () => onToggleShortlist(app.id)
          }>
