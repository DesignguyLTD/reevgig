                        ...
                        <div>
                            {
                                notificationTypes.map((notifyTags, id) =>
                                    <div className={styles.notify_info} key={notifyTags.title + id}>
                                        <span>
                                            <h5 className={styles.notifyTagsTitle}>{notifyTags.title}</h5>
                                            <p className={styles.notifyTagsDesc}>{notifyTags.desc}</p>
                                        </span>
                                        <span>
                                            <Toggle
                                                onClick={(value) => setToggleState((prevToggleStates) => prevToggleStates.map((toggler, i) => i === id ? value : toggler))}
