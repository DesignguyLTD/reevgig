        ...
        <div>
            <div className={style.ProfileCont}>
                <div className={style.profileEdit}>
                    <img src="https://res.cloudinary.com/do5wu6ikf/image/upload/v1725695190/Reev/Frame_stfpal.svg" alt="ProfilePic"/>
                    ...
                    <div className={style.editBtn} onClick={handleNavigation}>
                        <img src="https://res.cloudinary.com/do5wu6ikf/image/upload/v1725835490/Reev/mingcute_edit-2-line_rkyyvc.svg" alt="editIcon"/>
                        Edit Profile
                    </div>
                </div>
                ...
                <div className={style.applicationStatus}>
                    <div className={style.applicationCtn1}>
                        ...
                        <div className={style.Icon}>
                            <img src="https://res.cloudinary.com/do5wu6ikf/image/upload/v1725838665/Reev/Group_1171275752_ta0sxm.svg" alt="moreinfo"/>
                        </div>
                    </div>
