...
const PhoneInput = ({
    ...
    return (
        <div style={{textAlign: 'left'}}>
            {label && (
                <div className={`${styles.InputLabel} ${labelStyle} ${styles[`InputLabel--${size}`]}`}>
                    {label}
                </div>
            )}
            ...
            <div className={styles.container}>
                <input
                    ...
                    type="text"
                    value={valueInput}
                    style={{ width: '90px', height: '100%', borderRadius: '8px 0px 0px 8px', fontSize: '11px',color: '#6D8494', padding : '0px 10px 0 5px'}}
                    onChange={onChange}
                />
